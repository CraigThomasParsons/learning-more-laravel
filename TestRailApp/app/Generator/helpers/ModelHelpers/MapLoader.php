...
use Generator\model\Database\Map as MapRecord;
use Generator\model\Database\Tile as TileRecord;
use Generator\model\Database\Cell as CellRecord;
use Generator\model\Database\TileType;
